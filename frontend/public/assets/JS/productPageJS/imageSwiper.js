!function (e, t) {
  ...
  var Y = {
    ...
    modular: {
      ...
      updateSize: function () {
        ...
        var w = e.snapGrid.length, y = e.slidesGrid.length, b = a.spaceBetween, E = -m, x = 0, T = 0;
        if (void 0 !== s) {
          var C, M;
          ...
          S(e, {
            ...
            slidesGrid: h,
            slidesSizesGrid: v
          }), u !== d && e.emit("slidesLengthChange"), c.length !== w && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), h.length !== y && e.emit("slidesGridLengthChange"), (a.watchSlidesProgress || a.watchSlidesVisibility) && e.updateSlidesOffset()
        }
      ...
      slideTo: function (e, t, a, i) {
        ...
        if (l.cssMode) {
          ...
          return c && (C = h.scrollWidth - h.offsetWidth - C), 0 === t ? h[T ? "scrollLeft" : "scrollTop"] = C : h.scrollTo ? h.scrollTo(((x = {})[T ? "left" : "top"] = C, x.behavior = "smooth", x)) : h[T ? "scrollLeft" : "scrollTop"] = C, !0
        }
  ...
  var W = {
    ...
    getDistanceBetweenTouches: function (e) {
      ...
      var t, a, i, s, r, n, l, o, d, p, u, c, h, v, f, m, g = this, w = g.zoom, y = g.params.zoom, b = w.gesture,
        E = w.image;
